...
--[[
    The `updateAI` function takes a ball as parameter and changes the y
    coordinate of the paddel in a way that the center of the paddle is
    always aligned with the center of the ball. Therefore, the ball always
    hits the center of the AI paddle.
]]

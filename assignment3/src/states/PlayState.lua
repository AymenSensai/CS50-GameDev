...
--[[
    Swaps two tiles. 
    The 'swapBackOnNoMatch' parameter controls wether the tiles are swapped back if there is no match.
]]
...
function PlayState:calculateMatches(calculatedMatches)
    ...
    if matches then
        ...
        if not self.board:anyMatches() then
            ...
            -- start a transition of the text label to
            -- the center of the screen over 0.5 seconds
            Timer.tween(0.5, {
